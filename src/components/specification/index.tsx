...
<div className="max-sm:absolute top-[15%] space-y-10 ">
        ...
        <h3 className="max-sm:text-start text-xl">Model Air X Specification</h3>
     
      <div className="grid grid-cols-2 text-left md:grid-cols-2  gap-10 md:gap-24  md:text-left max-w-3xl  mx-auto">
      ...
      {/* Performance */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center gap-y-16 px-4 py-8 pt-24 ">
        ...
        <p className="text-xs text-wrap text-center max-sm:max-w-[110px] ">Minutes to charge 200 miles</p>
          <h3 className="text-5xl font-light">12</h3>
          <p className="text-4xl">mins</p>
        </div>
       
        <div className="space-y-8 text-center items-center flex flex-col ">
        <p className="text-xs text-wrap text-center max-sm:max-w-[110px] ">EPA estimated range up to</p>
